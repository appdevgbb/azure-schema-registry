...
namespace zohan.schemaregistry.events
{
	...
	{
		public static Schema _SCHEMA = Schema.Parse("{\"type\":\"record\",\"name\":\"CustomerLoyalty\",\"namespace\":\"zohan.schemaregistry.event" +
				"s\",\"fields\":[{\"name\":\"CustomerId\",\"type\":\"int\"},{\"name\":\"PointsAdded\",\"type\":\"in" +
				"t\"},{\"name\":\"Description\",\"type\":\"string\"}],\"version\":\"1.0\"}");
